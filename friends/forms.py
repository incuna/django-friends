...
if EmailAddress:
    class JoinRequestForm(forms.Form):
        ...
        def save(self, user):
            ...
            messages.info(self.request, 'Invitation to join sent to {0}'.format(join_request.contact.email))
            return join_request
...
class InviteFriendForm(UserForm):
    ...
    def save(self):
        ...
        messages.info(request, 'Friendship requested with {0}'.format(to_user.username)) # @@@ make link like notification
        return invitation
